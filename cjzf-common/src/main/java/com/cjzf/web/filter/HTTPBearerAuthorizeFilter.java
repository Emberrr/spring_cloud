package com.cjzf.web.filter;

import com.cjzf.exception.ResponseHandler;
...
/**
 * @ClassName HTTPBearerAuthorizeFilter
 * @Description
 * @author nicholas
...
public class HTTPBearerAuthorizeFilter extends ZuulFilter {
    private static final Logger log = LoggerFactory.getLogger(HTTPBearerAuthorizeFilter.class);
