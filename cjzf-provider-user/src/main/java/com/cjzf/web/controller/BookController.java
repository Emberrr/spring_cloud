...
import com.cjzf.service.BookService;
...
public class BookController extends BaseController {
    ...
    public BaseResponse saveBook(@Valid
                                 @ApiParam(value = "添加的某本书籍信息", required = true)
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 404, message = "Not Found"),
            @ApiResponse(code = 500, message = "Failure")})
    public BaseResponse updateBook(@NotNull
                                   @ApiParam(value = "要更新的某本书籍ID", required = true)
                                   @PathVariable("bookId") Integer bookId,
                                   @Valid @ApiParam(value = "要更新的某本书籍信息", required = true)
